  ...
  return (
    <AppLayout title="Certifications">
      <div className="certificate-container">
        ...
        {/* Certificate 1: Google Data Analytics */}
        <div className="certificate-card animate__animated animate__fadeInUp animate__faster">
        ...
        {/* Certificate 2: Google Project Management */}
        <div
          className="certificate-card animate__animated animate__fadeInUp animate__faster animate__delay"
        ...
        {/* Certificate 3: Google UX Design */}
        <div className="certificate-card animate__animated animate__fadeInUp animate__faster animate__delay-1s">
